...
The analysis of this data produces the following findings:  it is more likely for a fundraising campiagn for a play to be successful if it is launched near the second quarter (April, May, June, July) and if the fundraising goal is either lowered to be less than $5000 or increased to be between $10,000 and $19,000. 

Recommendation for a graph of only data points of play campaigns 
